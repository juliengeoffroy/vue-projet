  <template>
    <div class="banner-1">
      ...
      >
        ...
        >
          ...
          <li class="menu-button"><a href="#mesprojets" v-smooth-scroll>MES PROJETS</a></li>
          <li class="menu-button">
            <a href="#testimonial" v-smooth-scroll>Testimonials</a>
          </li>
          <li class="menu-button"><a href="#apropos" v-smooth-scroll>A PROPOS</a></li>
        </ul>
      </nav>
      <!-- End Navbar -->
    ...
    <div class="banner-2 space-y-10 pb-20" id="work">
      <h3 class="heading3 my-5">MES PROJET</h3>
      <div class="card">
        <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
          <h4 class="project-title item">PORTFOLIO</h4>
          <p class="font-work_sans pr-12">
            Réalisation d'un Portfolio. Et de pouvoir y importer les différents projets réalise( CV, Cahier Des Charges et Espace Commentaire).
          </p>
      ...
      <div class="card">
        <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
          <h4 class="project-title item">Cahier des Charges</h4>
          <p class="font-work_sans pr-12">
            Cahier Des Charges pour un site internet de la Socketterie.
          </p>
          <button class="text-sky-800 font-bold text-2xl tracking-wider">
            CDC
          </button>
      ...
      <div class="card">
        <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
          <h4 class="project-title">Espace Commentaire</h4>
          <button class="text-sky-800 font-bold text-2xl tracking-wider">
           EC
          </button>
        </div>
    ...
    <div class="banner-2 md:flex items-center md:justify-evenly" id="apropos">
      <img
      ...
      />
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">A PROPOS</h4>
        <p class="font-work_sans">
          Je m'appelle Julien Geoffroy,j'ai 35 ans. Je travail acctuellement dans l'agro-alimentaire comme réceptionneur et controleur des matière d'embalage les produits a l'entreprise Maison Monterrad à feillens 01. 
          <br />
          J'ai decider de faire cette formation pour apprendre ce metier, j'ai toujours étè pasionné par tout ce qui se ratache a l'informatique, j'aimé beaucoup sa. Ne pouvant pas faire se genre formation à l'école ou autre étant plus jeune c'est pour sa que j'ai décidé de me lancer dans cette formation.
        </p>
        <button class="text-sky-800 font-bold text-2xl tracking-wider">
          PROJETS
        </button>
